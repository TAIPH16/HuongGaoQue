...
const CustomerEditForm = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      await customersAPI.update(id, formDataToSend);
      setSuccessModal({ isOpen: true, message: 'Cập nhật thông tin khách hàng thành công' });
  ...
  return (
    <MainLayout title="Chỉnh sửa hồ sơ khách hàng">
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Chỉnh sửa thông tin khách hàng</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none bg-gray-100 cursor-not-allowed"
                required
                readOnly
              />
            </div>
