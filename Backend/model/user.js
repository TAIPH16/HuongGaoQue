...
const userSchema = new mongoose.Schema(
  {
    ...
    farmOwnerName: { type: String, default: "" },
    farmContactPhone: { type: String, default: "" },
    ...
    role: { type: String, enum: ["user", "admin", "guest", "seller"], default: "user" },
    ...
    login_history: [
      {
        ...
        login_type: { type: String, enum: ["email", "google"], required: true },
      },
    ],
  },
  {
